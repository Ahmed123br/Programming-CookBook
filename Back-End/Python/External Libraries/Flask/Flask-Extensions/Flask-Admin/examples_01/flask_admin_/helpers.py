...
from _compat import urljoin, urlparse, iteritems
...
# Assisgns Admin's view to Flask g
...
# TODO replace iteritems with viewitems()
...
def is_safe_url(target):
    ...
    target_scheme = target_info.target_scheme
