...
@app.route('/')
def index():
    return '<a href="/admin/">Clicl me to get to Admin </a>'


# app.config['FLASK_ADMIN_SWATCH] = 'Minty'

# Create Admin with custom base template
admin = admin.Admin(app, 'Admin Console', template_mode='bootstrap4')
...
# Pre populate db with dummy users
def build_sample_db():
...
if __name__ == '__main__':
    # Build a sample db on the fly if one doesn't exists
